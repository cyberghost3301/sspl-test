...
const benefits: BentoItem[] = [
  ...
  { icon: BarChart3, title: "Analytics & Dashboards", description: "Custom analytics platforms with real-time data visualization, KPI tracking, report generation, and business intelligence integrations.", span: "wide" },

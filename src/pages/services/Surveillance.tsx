...
const benefits: BentoItem[] = [
  ...
  { icon: Video, title: "Video Analytics Dashboard", description: "Centralized analytics with heatmaps, people counting, dwell time analysis, and crowd density monitoring for operational insights." },
  ...
  { icon: LayoutGrid, title: "Multi-Site Management", description: "Unified command center for managing surveillance across multiple locations with role-based access and centralized policy enforcement.", span: "wide" },

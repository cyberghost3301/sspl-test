...
const benefits: BentoItem[] = [
  ...
  { icon: Database, title: "Data Loss Prevention", description: "DLP policy design, sensitive data classification, exfiltration monitoring, and automated blocking of unauthorized data transfers." },
  ...
  { icon: Cloud, title: "Disaster Recovery Planning", description: "Business continuity strategies, backup validation, RTO/RPO optimization, and automated failover testing for critical systems.", span: "wide" },

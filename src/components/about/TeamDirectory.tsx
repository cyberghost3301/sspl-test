...
const developmentTeam = [
  ...
  { name: "Sanchita Nath", role: "SMM Coordinator", imageUrl: "/src/assets/pp/sanchita.jpg", linkedin: "#" },
  { name: "Astha Dwivedi", role: "BDA", imageUrl: "/src/assets/pp/astha.jpg", linkedin: "#" },

...
function CSuiteCard({ member, index }: { member: (typeof cSuite)[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="group relative p-7 lg:p-9 rounded-2xl border border-border bg-card hover:border-accent/40 hover:shadow-xl hover:shadow-accent/5 transition-all duration-300"
    >
      {/* Badge top-right */}
      ...
      <div className="flex flex-col sm:flex-row items-start gap-6">
        {/* Avatar */}
        <div className="w-24 h-24 shrink-0 rounded-2xl bg-secondary ring-2 ring-cyan-500/20 flex items-center justify-center group-hover:ring-cyan-500/40 transition-all overflow-hidden">
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-start gap-4">
        {/* Avatar */}
        <div className="w-14 h-14 shrink-0 rounded-xl bg-secondary ring-2 ring-cyan-500/20 flex items-center justify-center group-hover:ring-cyan-500/40 transition-all overflow-hidden">
          {member.imageUrl && member.imageUrl !== "/placeholder.svg" ? (
            <img src={member.imageUrl} alt={member.name} width="400" height="400" loading="lazy" className="w-full h-full object-cover" />
          ) : (
        ...
        <div className="flex-1 min-w-0 pr-8">
          <h4 className="font-display text-base font-bold text-foreground mb-0.5">
            {member.name}
          </h4>
